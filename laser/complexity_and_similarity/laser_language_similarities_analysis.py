...
def create_heatmap_for_language(language):
    ...
    plt.savefig(f'laser/complexity_and_similarity/compound/heatmaps/compound_{language.lower()}_similarity_heatmap.png', format='png')
...
def create_wordcloud_for_language(language):
    ...
    plt.savefig(f'laser/complexity_and_similarity/compound/wordclouds/compound_{language.lower()}_similarity_wordcloud.png', format='png')
...
language_similarities = pd.read_csv("laser/complexity_and_similarity/compound/laser_language_similarities.csv")
...
plt.savefig('laser/complexity_and_similarity/compound/heatmaps/compound_all_languages_similarity_heatmap.png', format='png')
