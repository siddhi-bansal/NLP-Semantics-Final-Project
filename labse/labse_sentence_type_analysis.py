...
def create_boxplots(simple_cosines, compound_cosines, complex_cosines):
    ...
    plt.savefig("labse_large_sentence_types_boxplot.png", format="png")
...
with open('labse_embeddings.json', 'r') as file:
...
print("Cross-lingual similarity of simple sentences for LaBSE Embeddings", simple_cosine_avg)
print("Cross-lingual similarity of compound sentences for LaBSE embeddings", compound_cosine_avg)
print("Cross-lingual similarity of complex sentences for LaBSE Embeddings", complex_cosine_avg)