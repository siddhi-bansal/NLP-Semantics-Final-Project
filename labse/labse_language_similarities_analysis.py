...
def create_heatmap_for_language(language):
    ...
    plt.savefig(f'labse/heatmaps/{language.lower()}_similarity_heatmap.png', format='png')
...
def create_wordcloud_for_language(language):
    ...
    wordcloud.to_file(f'labse/wordclouds/{language.lower()}_similarity_wordcloud.png')
...
language_similarities = pd.read_csv("labse_language_similarities.csv")
...
plt.savefig('labse/heatmaps/all_languages_similarity_heatmap.png', format='png')
